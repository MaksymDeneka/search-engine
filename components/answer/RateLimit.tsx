export default function RateLimit() {
  return (
    <div className="bg-neutral-800 border border-red-900/50 rounded-lg p-4 animate-in fade-in duration-300">
      <div className="flex items-center gap-3 mb-2">
        <div className="w-8 h-8 bg-red-900/30 text-red-400 rounded-full flex items-center justify-center flex-shrink-0">
          <svg
            width="16"
            height="16"
            viewBox="0 0 24 24"
        ...
        <h2 className="text-lg font-medium text-red-400">Rate Limit Reached</h2>
      </div>

      <p className="text-gray-300 pl-11">
        You've reached the maximum number of requests allowed. Please try again later or upgrade
      ...
      <div className="mt-4 pl-11">
        <a
          href="#"
          className="inline-flex items-center justify-center px-4 py-2 bg-red-900/30 hover:bg-red-900/50 text-red-400 rounded-lg transition-colors text-sm">
          Upgrade Plan
        </a>
      </div>
    </div>
